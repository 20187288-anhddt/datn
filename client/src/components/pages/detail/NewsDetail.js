          ...
          {comments ? (
            comments.length > 0 ? (
              comments.map((comment, index) => (
                <div
                  key={index}
                  className="comment mt-3 border-0 rounded p-2 bg-light"
                >
                  <div className="comment__user">
                    <div className="comment__photo rounded">
                      <img
                        src={`/uploads/users/${comment.createdBy.image}`}
                  ...
                  <small>
                    Vào lúc: {moment(comment.date).format("HH:mm DD/MM/YYYY")}{" "}
                    {comment.createdBy._id === userId ? (
                      <span
                        className="badge badge-pill badge-secondary cursor-pointer"
